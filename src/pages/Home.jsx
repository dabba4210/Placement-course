                        ...
                        <div className="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg shadow-lg overflow-hidden transition-transform duration-500 hover:scale-105">
                            <a href="#">
                                ...
                                <div className="p-6">
                                    ...
                                    <h3 className="mt-4 text-2xl font-bold">Python Development Master Course <i>@Supreme</i> Batch</h3>
                                    <hr className="my-4 border-gray-200 dark:border-gray-700 w-3/4 mx-auto" />
                                    <div className="flex justify-center items-center space-x-4">
                                        <p className="text-2xl font-bold text-blog">₹699</p>
                                        <p className="text-lg line-through text-gray-500">₹2499</p>
                                        <p className="px-3 py-1 text-sm font-bold text-white bg-green-500 rounded-md">70% off</p>
                                    </div>
                                </div>
                            </a>
                        </div>
